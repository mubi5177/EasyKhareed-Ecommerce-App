          ...
          child: CustomScrollView(
            ...
            slivers: [
              SliverList(
                ...
                Container(height:30,child: Center(child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return Address();
                    })).then((value) {
                  ...
                  child: Padding(
                    ...
                    child: Text("Go to address page",style:TextStyle(decoration: TextDecoration.underline,color: Colors.deepPurple),),
                  ),
                ))),
                SizedBox(
                  height: 100,
